...
# we can use the turtle things inside this "container"
    def __init__(self, spriteshape, color, startx, starty):
        ...
        # Ex.1.a - Scrieti o functie care sa faca orice obiect sa se miste
...
class Player(Sprite):
    ...
    # Ex. 2 - Adaugati functiile necesare pentru ca un jucator:
    # sa se miste spre dreapta
    # sa se miste spre stanga
    # sa accelereze
    # sa decelereze
...
# Ex.3 - Adaugati comenzi de la tastatura pentru a misca jucatorul in jos, pentru a accelera si decelera
# turtle.onkey(player.turn_left, "Left")


# Ex.1.b - Adaugati o instructiune care sa faca jocul sa ruleze la infinit
